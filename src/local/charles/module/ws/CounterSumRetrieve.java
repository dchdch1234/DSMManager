 ...
 *       &lt;sequence>
 *         &lt;element name="counterFilter" type="{urn:Manager}EnumCounterSumFilter"/>
...
@XmlRootElement(name = "counterSumRetrieve")
public class CounterSumRetrieve {

    @XmlElement(required = true)
    protected EnumCounterSumFilter counterFilter;
    @XmlElement(required = true)
     ...
     * @return
     *     possible object is
     *     {@link EnumCounterSumFilter }
     *     
     */
    public EnumCounterSumFilter getCounterFilter() {
     ...
     *     
     */
    public void setCounterFilter(EnumCounterSumFilter value) {
