 ...
 *         &lt;element name="includeNonHostEvents" type="{http://www.w3.org/2001/XMLSchema}boolean"/>
...
@XmlType(name = "", propOrder = {
    ...
    "hostFilter",
    "eventIdFilter",
    "includeNonHostEvents",
    "sid"
})
@XmlRootElement(name = "systemEventRetrieve")
public class SystemEventRetrieve {
    ...
    protected boolean includeNonHostEvents;
    ...
    /**
     * Gets the value of the includeNonHostEvents property.
     * 
     */
    public boolean isIncludeNonHostEvents() {
        return includeNonHostEvents;
    }

    /**
     * Sets the value of the includeNonHostEvents property.
     * 
     */
    public void setIncludeNonHostEvents(boolean value) {
        this.includeNonHostEvents = value;
    }
