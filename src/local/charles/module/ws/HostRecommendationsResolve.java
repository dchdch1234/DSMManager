 ...
 *         &lt;element name="ruleIDs" type="{http://www.w3.org/2001/XMLSchema}int" maxOccurs="unbounded"/>
...
@XmlRootElement(name = "hostRecommendationsResolve")
public class HostRecommendationsResolve {
     ...
     * This is why there is not a <CODE>set</CODE> method for the ruleIDs property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getRuleIDs().add(newItem);
     * </pre>
     * 
     * 
     * <p>
